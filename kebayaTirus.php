...
<div class="main">
	<br/><br/>
	<center>
	  <img src="Kebaya/kebaya4.jpg" width="380" height="400"/>
	</center>
</div>
...
$sqlone = "SELECT itemCode,itemName,itemMaterial,itemPrice
		   FROM kebaya
		   WHERE itemCode LIKE '%KB-40%'";//the query for get all data in kebaya
...
?>	
<br>
	<form name="form1" action="kebayaTirusPross.php" method="POST">
		<!--name of the item-->
