<html>
<head><title>July's Memoir</title>
</head>
...
<div class="main">
	<br/><br/>
	<center>
	  <img src="Jubah/Jubah3.jpg" width="380" height="400"/>
	</center>
</div>
...
$sqlone = "SELECT itemCode,itemName,itemMaterial,itemPrice
		   FROM abaya
		   WHERE itemCode LIKE '%AB-30%'";//the query for get all data in abaya
...
?>	
<br>
	<form name="form1" action="abayaMemoirPross.php" method="POST">
		<!--name of the item-->
