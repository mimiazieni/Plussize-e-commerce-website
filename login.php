<?php
session_start();
if(isset($_SESSION['CUSTEMAIL']) && ($_SESSION['LEVEL'] == 1))
{ 
	$INDEX = $_SESSION['CUSTEMAIL'];
...
<div class="cont_principal">
  ...
  <center><h1><font color="#FF3366" > Sign In now !</font></h1> </center>
...
<div class="cont_btn">
     <button class="btn_sign" name="submit1">SIGN IN</button>
</div>
