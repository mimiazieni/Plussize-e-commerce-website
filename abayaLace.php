...
<div class="main">
	<br/><br/>
	<center>
	  <img src="Jubah/Jubah1.jpg" width="380" height="400"/>
	</center>
</div>
...
$sqlone = "SELECT itemCode,itemName,itemMaterial,itemPrice
		   FROM abaya
		   WHERE itemCode LIKE '%AB-10%'";//the query for get all data in abaya
...
?>	
<br>
	<form name="form1" action="abayaLacePross.php" method="POST">
    	<!--name of the item-->
