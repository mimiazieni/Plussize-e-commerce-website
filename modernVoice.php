<html>
<head><title>Septermber's Voice</title>
</head>
...
<div class="main">
	<br/><br/>
	<center>
	  <img src="Modern/kurungmodern3.jpg" width="380" height="400"/>
	</center>
</div>
...
$sqlone = "SELECT itemCode,itemName,itemMaterial,itemPrice
		   FROM modern
		   WHERE itemCode LIKE '%MB-30%'";//the query for get all data in modern
...
?>	
<br>
	<form name="form1" action="modernVoicePross.php" method="POST">
		<!--name of the item-->
        ...
        <tr bgcolor="">
			<td>Color&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</td>
			<td>Blue, Purple, Red & Turquoise</td>
		</tr>
