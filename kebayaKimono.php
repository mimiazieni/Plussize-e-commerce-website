<html>
<head><title>Kebaya Kimono</title>
</head>
...
<div class="main">
	<br/><br/>
	<center>
	  <img src="Kebaya/kebaya3.jpg" width="350" height="400"/>
	</center>
</div>
...
$sqlone = "SELECT itemCode,itemName,itemMaterial,itemPrice
		   FROM kebaya
		   WHERE itemCode LIKE '%KB-30%'";//the query for get all data in kebaya
...
?>	
<br>
	<form name="form1" action="kebayaKimonoPross.php" method="POST">
		<!--name of the item-->
