<html>
<head><title>Kebaya Lembayung</title>
</head>
...
<div class="main">
	<br/><br/>
	<center>
	  <img src="Kebaya/kebaya2.jpg" width="380" height="400"/>
	</center>
</div>
...
$sqlone = "SELECT itemCode,itemName,itemMaterial,itemPrice
		   FROM kebaya
		   WHERE itemCode LIKE '%KB-20%'";//the query for get all data in kebaya
...
?>	
<br>
	<form name="form1" action="kebayaLembayungPross.php" method="POST">
		<!--name of the item-->
