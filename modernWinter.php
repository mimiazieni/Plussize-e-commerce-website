...
<div class="main">
	<br/><br/>
	<center>
	  <img src="Modern/kurungmodern2.jpg" width="380" height="400">
	</center>
</div>
...
$sqlone = "SELECT itemCode,itemName,itemMaterial,itemPrice
		   FROM modern
		   WHERE itemCode LIKE '%MB-20%'";//the query for get all data in modern
...
?>	
<br>
	<form name="form1" action="modernWinterPross.php" method="POST">
		<!--name of the item-->
