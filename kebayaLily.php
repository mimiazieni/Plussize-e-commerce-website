...
<div class="main">
	<br/><br/>
	<center>
	  <img src="Kebaya/kebaya5.jpg" width="380" height="400"/>
	</center>
</div>
...
$sqlone = "SELECT itemCode,itemName,itemMaterial,itemPrice
		   FROM kebaya
		   WHERE itemCode LIKE '%KB-50%'";//the query for get all data in kebaya
...
?>	
<br>
	<form name="form1" action="kebayaLilyPross.php" method="POST">
		<!--name of the item-->
